...
export default function BookCover({
        ...
        <div className="relative h-[620px] w-[430px] rounded-r-[2.8rem] rounded-l-xl border border-amber-300 bg-gradient-to-br from-[#0d1b35] via-[#183763] to-[#06101f] p-10 text-left text-white shadow-[28px_36px_80px_rgba(0,0,0,0.48)] transition-all duration-700 group-hover:-rotate-2 group-hover:-translate-y-6 group-hover:shadow-[45px_60px_120px_rgba(0,0,0,0.65)]">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div>
              ...
              <h1 className="mt-10 text-6xl font-black leading-tight tracking-tight">
                {title}
              </h1>
  ...
  flashcards, and visual understanding.
            ...
            <div>
              <p className="text-sm font-semibold text-amber-200">{author}</p>
