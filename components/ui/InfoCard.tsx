export interface InfoCardProps {
  ...
  const TONE_CLASSES = {
    default: "bg-white shadow-[0_20px_60px_rgba(75,45,12,0.10)] ring-1 ring-black/5 text-slate-900",
    amber:   "bg-amber-50 ring-1 ring-amber-200 text-amber-800",
    dark:    "bg-slate-950 text-white shadow-lg",
  };
   ...
   * the app (rounded-3xl, warm shadow, consistent padding). */
